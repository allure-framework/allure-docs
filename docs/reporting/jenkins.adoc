...
. Go to the
link:https://repo.maven.apache.org/maven2/io/qameta/allure/allure-commandline/[Maven Central page], click the latest released version, and download the allure-commandline-[version].zip file.
