...
* Download and uzip the latest link:https://dl.bintray.com/qameta/generic/io/qameta/allure/allure/2.0.0/allure-2.0.0.zip[allure-commandline]. Or you can use the following link:https://github.com/qameta/homebrew-allure[brew formula] to simplify the process.
