...
Scenario inherite a feature severity, the same way, scenario severity is overdride a feature severity. When situated more
than one severity definition tag, last one is used.
